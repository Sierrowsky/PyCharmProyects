...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(80, 30, 900, 180))
        self.frame.setMinimumSize(QtCore.QSize(800, 90))
        self.frame.setMaximumSize(QtCore.QSize(900, 180))
        ...
        self.txtNombre.setGeometry(QtCore.QRect(470, 60, 300, 20))
        ...
        self.cmbLocalidad.setGeometry(QtCore.QRect(650, 100, 120, 22))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("img/exit_icon-icons.com_70975.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        self.barSalir.setIcon(icon2)
        self.barSalir.setObjectName("barSalir")
        self.barLimpiarPanel = QtGui.QAction(parent=MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("img/reload_icon-icons.com_64795.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.barLimpiarPanel.setIcon(icon3)
        ...
        MainWindow.setTabOrder(self.cmbLocalidad, self.txtTlf)
